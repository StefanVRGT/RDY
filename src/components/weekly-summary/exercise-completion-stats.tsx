...
const TYPE_CONFIG = {
  ...
  audio: { icon: Mic, label: 'Audio', color: 'text-blue-400' },
    ...
    >
      ...
      <div className="mb-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <CheckCircle2 className="h-5 w-5 text-twilight-400" />
          <h3 className="font-semibold text-white">Exercise Completion</h3>
        </div>
        ...
        <div className="relative h-32 w-32">
          ...
          <svg className="h-full w-full -rotate-90">
            ...
            <circle
              ...
              strokeLinecap="round"
              className="text-twilight-400 transition-all duration-500"
      ...
      >
        <div className="text-center">
          <p className="text-2xl font-bold text-twilight-400" data-testid="completed-count">
        ...
        <div className="text-center">
          <p className="text-2xl font-bold text-white" data-testid="total-count">
        ...
        <div className="h-8 w-px bg-gray-700" />
        <div className="text-center">
          <p className="text-2xl font-bold text-gray-400" data-testid="previous-week-rate">
      ...
      <div className="mb-4">
        <p className="mb-2 text-xs font-medium text-gray-400">Daily Progress</p>
        <div className="flex items-end justify-between gap-1" data-testid="daily-bars">
          {dailyBars.map((day, idx) => (
            ...
            >
              <div className="relative mb-1 h-16 w-full rounded-t bg-gray-800">
                <div
                  className="absolute bottom-0 left-0 right-0 rounded-t bg-twilight-500 transition-all duration-300"
      ...
      {Object.keys(stats.byType).length > 0 && (
        <div data-testid="by-type-breakdown">
          <p className="mb-2 text-xs font-medium text-gray-400">By Type</p>
