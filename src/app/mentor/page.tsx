...
import { Calendar, Users, Clock, TrendingUp, RefreshCw, BookOpen, MessageSquare, ChevronRight, BarChart3 } from 'lucide-react';
...
export default function MentorHomePage() {
  ...
  const { data: todaysSessions, isLoading: todaysLoading } = trpc.mentor.getTodaysSessions.useQuery();
  const { data: upcomingSessions, isLoading: upcomingLoading } = trpc.mentor.getUpcomingSessions.useQuery({ limit: 5 });
    ...
    <MobileLayout title="Mentor Dashboard" showNotifications>
      ...
      >
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-gray-400">Here&apos;s your overview for today</p>
        </div>

        {/* Quick stats */}
        <div className="mb-6 grid grid-cols-2 gap-4" data-testid="stats-grid">
          <div className="rounded-xl bg-gray-900 p-4" data-testid="stat-sessions-today">
          ...
          <div className="rounded-xl bg-gray-900 p-4" data-testid="stat-active-mentees">
          ...
          <div className="rounded-xl bg-gray-900 p-4" data-testid="stat-classes">
        ...
        <div className="mb-6" data-testid="quick-actions">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Link
              href="/mentor/classes"
              className="flex items-center gap-3 rounded-xl bg-twilight-600 p-4 text-white transition-colors hover:bg-twilight-500"
            ...
            <Link
              ...
              className="flex items-center gap-3 rounded-xl bg-gray-800 p-4 text-white transition-colors hover:bg-gray-700"
        ...
        <div className="mb-6" data-testid="my-classes-section">
          <div className="mb-4 flex items-center justify-between">
            ...
            <Link
              href="/mentor/classes"
              className="flex items-center text-sm text-twilight-400 hover:text-twilight-300"
            >
              View all
              ...
              myClasses.slice(0, 3).map((cls) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <div className={`h-2 w-2 rounded-full ${cls.status === 'active' ? 'bg-green-500' : 'bg-gray-500'}`} />
        ...
        <div className="mb-6" data-testid="todays-sessions-section">
          <h3 className="mb-4 text-lg font-semibold text-white">
            ...
            {todaysSessions && todaysSessions.length > 0 && (
              <span className="ml-2 rounded-full bg-twilight-600 px-2 py-0.5 text-sm">
          ...
          <div className="space-y-3" data-testid="todays-sessions-list">
            {todaysLoading ? (
              ...
              todaysSessions.map((session) => (
                <div
                  key={session.id}
                  className="rounded-xl border-l-4 border-twilight-500 bg-gray-900 p-4"
            ...
            {upcomingLoading ? (
              ...
              upcomingSessions.map((session) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <p className={`text-sm font-medium ${isToday(session.scheduledAt) ? 'text-twilight-400' : 'text-gray-300'}`}>
